...
const AccountCard = () => {
  return (
    <div title='sign in/up' className="p-8 shadow-lg rounded-xl bg-gray-400">
        ...
        <div className='inline-block text-center rounded-lg w-48 mr-2 px-10 py-4 border-none bg-slate-200 cursor-pointer outline-none hover:shadow-xl my-8'>
            <span className="block text-gray-500 mx-auto text-sm font-bold">LOG IN</span>
        </div>
        <div className='inline-block text-center rounded-lg w-48 mr-2 px-10 py-4 border-none bg-slate-800 cursor-pointer outline-none hover:shadow-xl my-8'>
