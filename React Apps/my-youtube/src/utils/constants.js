...
export const THUMBS_UP_LOGO = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_NNd8DVRo9EAPPHJnEoFG6TeiS2QIfaYGkA&s';
export const THUMBS_DOWN_LOGO = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNW3-ilqxyIpGbpMLX3n2adyT9ALLkJlbnVw&s';

export const LIVE_COUNT = 10;
export const DEFAULT_FILTER_BUTTON = ['All','Music','Thrillers','Movie','Tamil cinema','History','Live','Thoughts','Wealth','Self Confidence','Entrepreurship','Sports','Cricket','NewToYou'];
...
export const YOUTUBE_SEARCH_RESULTS = 'https://youtube.googleapis.com/youtube/v3/search?maxResults=50&key='